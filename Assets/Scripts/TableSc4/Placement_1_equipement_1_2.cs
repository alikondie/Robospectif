...
public class Placement_1_equipement_1_2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        x_position_1_carte_1 = -2.62f;
        y_position_1_carte_1 = 0.89f;
        x_position_1_carte_2 = -2.62f;
        y_position_1_carte_2 = 0.67f;
        x_position_1_carte_3 = -2.62f;
        y_position_1_carte_3 = 0.42f;

        carte_1_position_2 = false;
        x_position_2_carte_1 = -0.1f;
        y_position_2_carte_1 = 0.89f;
        x_position_2_carte_2 = -0.1f;
        y_position_2_carte_2 = 0.67f;
        x_position_2_carte_3 = -0.1f;
        y_position_2_carte_3 = 0.42f;

        carte_1_position_3 = false;
        x_position_3_carte_1 = 2.51f;
        y_position_3_carte_1 = 0.89f;
        x_position_3_carte_2 = 2.51f;
        y_position_3_carte_2 = 0.67f;
        x_position_3_carte_3 = 2.51f;
        y_position_3_carte_3 = 0.42f;
    }
    ...
    void Update()
    {
            ...
            equipement.transform.position.x != x_position_1_carte_3)
        {
                ...
                equipement.transform.position.y != y_position_1_carte_3)
            {
                ...
                switch (Nb_carte_position_1_2.nb_carte_position_1)
                {
                    case 1:
            ...
            equipement.transform.position.x != x_position_2_carte_3)
        {
                ...
                equipement.transform.position.y != y_position_2_carte_3)
            {
                ...
                switch (Nb_carte_position_1_2.nb_carte_position_2)
                {
                    case 1:
            ...
            equipement.transform.position.x != x_position_3_carte_3)
        {
                ...
                equipement.transform.position.y != y_position_3_carte_3)
            {
                ...
                switch (Nb_carte_position_1_2.nb_carte_position_3)
                {
                    case 1:
