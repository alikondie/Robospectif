...
public class MainScript : MonoBehaviour
{
    ...
    private void OnCardsReceived(NetworkMessage netMsg)
    {
        ...
        if (v.num == JoueurStatic.Numero)
        {
            ...
            JoueurStatic.Locomotions[1] = Resources.Load<Sprite>("FR/Locomotion/" + v.loco2);
            JoueurStatic.Equipements[0] = Resources.Load<Sprite>("FR/Equipements/" + v.equi1);
            JoueurStatic.Equipements[1] = Resources.Load<Sprite>("FR/Equipements/" + v.equi2);
            JoueurStatic.Equipements[2] = Resources.Load<Sprite>("FR/Equipements/" + v.equi3);
            JoueurStatic.Equipements[3] = Resources.Load<Sprite>("FR/Equipements/" + v.equi4);
            JoueurStatic.Equipements[4] = Resources.Load<Sprite>("FR/Equipements/" + v.equi5);
            JoueurStatic.Equipements[5] = Resources.Load<Sprite>("FR/Equipements/" + v.equi6);
            JoueurStatic.Persos[0] = Resources.Load<Sprite>("FR/Personnages/" + v.perso1);
            JoueurStatic.Persos[1] = Resources.Load<Sprite>("FR/Personnages/" + v.perso2);
            JoueurStatic.Persos[2] = Resources.Load<Sprite>("FR/Personnages/" + v.perso3);
            JoueurStatic.Persos[3] = Resources.Load<Sprite>("FR/Personnages/" + v.perso4);
            JoueurStatic.Persos[4] = Resources.Load<Sprite>("FR/Personnages/" + v.perso5);
            JoueurStatic.Persos[5] = Resources.Load<Sprite>("FR/Personnages/" + v.perso6);
